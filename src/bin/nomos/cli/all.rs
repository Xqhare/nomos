...
impl<'c> CliCommand<'c> for All {
    ...
    fn long_about(&self) -> String {
        "Provides a list of all tasks, sorted by kahn's algorithm. Top should be done first."
            .to_string()
    }
    ...
    #[expect(
        ...
        reason = "tried to move logic out of this function, ran into borrow checker issues with 'out' mutability"
    )]
